...
class _Package extends \IPS\Node\Model
{
	...
	public function form( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\YesNo( 'sp_renews', !empty( $renewOptions ), FALSE, array( 'togglesOn' => array( 'sp_renew_options' ), 'togglesOff' => array( 'sp_renew_upgrade' ) ), NULL, NULL, NULL, 'sp_renews' ) );
	...
	public function renewMember( $member )
	{
		try
		{
			...
			$sub = \IPS\nexus\Subscription::loadByMemberAndPackage( $member, $this );
