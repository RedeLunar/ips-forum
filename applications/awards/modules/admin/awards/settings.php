...
class _settings extends \IPS\Dispatcher\Controller
{
    ...
    protected function manage()
    {
        ...
        $form->addHeader( 'award_tab_notification' );
		...
		$form->addHeader('award_settings_header_editing_award');
		$form->add( new \IPS\Helpers\Form\YesNo( 'award_settings_require_reason', \IPS\Settings::i()->award_settings_require_reason, FALSE, array(), NULL, NULL, NULL, 'award_settings_require_reason' ) );

        $form->addHeader('award_settings_misc_permission');
        $form->add( new \IPS\Helpers\Form\YesNo( 'award_settings_guest_view_awarded', \IPS\Settings::i()->award_settings_guest_view_awarded, FALSE, array(), NULL, NULL, NULL, 'award_settings_guest_view_awarded' ) );
        ...
        $form->add(new \IPS\Helpers\Form\Number( 'award_settings_show_awards', \IPS\Settings::i()->award_settings_show_awards, FALSE, array( 'min' => 3, 'max' => 25 ), NULL, NULL, NULL, 'award_settings_show_awards'));
        $form->add( new \IPS\Helpers\Form\YesNo( 'award_settings_show_giver', \IPS\Settings::i()->award_settings_show_giver, FALSE, array(), NULL, NULL, NULL, 'award_settings_show_giver' ) );
