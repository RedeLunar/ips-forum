...
class _Awards
{
    ...
    public function showTab()
    {
        ...
        {
            $where[] = array( 'awarded_member = ? AND awarded_id NOT IN (?)', $this->member->member_id, $this->member->award_member_show  );
        }
        else
        {
        ...
        $count = \IPS\Db::i()->select( 'COUNT(*)', 'awards_awarded', $where )->first();
    ...
    public function render()
    {
        ...
        $table->limit 			= \IPS\Settings::i()->award_settings_show_awards ? \IPS\Settings::i()->award_settings_show_awards : 10;
