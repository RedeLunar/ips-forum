...
class _license extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'lkey', '57d24a159dc3e818b497640bcd6540a3', TRUE, array( 'size' => 50 ), function( $val )
		{
		...
		if ( $values = $form->values() )
		{
			...
			$toWrite = "<?php\n\n" . '$INFO = ' . var_export( array( 'lkey' => '57d24a159dc3e818b497640bcd6540a3' ), TRUE ) . ';';
